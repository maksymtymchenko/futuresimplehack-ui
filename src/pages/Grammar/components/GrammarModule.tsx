...
export const GrammarModule = () => {
  ...
  const handleClick = () => navigate('/grammar');

  return <Grid container direction='column' spacing={3}>
    <Grid item display='flex' gap={2} mb={2}>
      <IconButton onClick={handleClick}><ArrowBackIosNewRoundedIcon /></IconButton>
    ...
    <Grid item>
      <Card path='/grammar/module-1' title='Unit 2: Articles a/an, the, no article' units={secondUnitTopics}/>
    </Grid>
  </Grid>;
};